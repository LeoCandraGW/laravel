    ...
    <body>
        ...
        <?php $__currentLoopData = $hasil; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $h): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
         <input type="hidden" name="id" value="<?php echo e($h->id); ?>">
            <tr>
                <td>nama</td>
                <td><input type='text' name='nama' value='<?php echo e($h->nama); ?> edited' required></td></tr>
                ...
                <td><input type='date' name='tanggal_masuk' value='<?php echo e($h->tanggal_masuk); ?>' required></td></tr>
                <tr><td>tanggal keluar</td>
                <td><input type='date' name='tanggal_keluar' value='<?php echo e($h->tanggal_keluar); ?>' required></td></tr>
                <tr><td>gaji</td>
